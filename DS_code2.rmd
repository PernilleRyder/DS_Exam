...
#Vi skal have smidt nogle lables på her
...
#Difference between rain_gap og rain_full:
#8768-8197 = 571
```
...
#Hvis i gør som jeg lige skrev tager i mean på tværs af alle sites/områder i har – et ’globalt’ mean. Hvis i til gengæld #laver group_by_key() og fill_gaps, skulle den gerne udregne et mean per område, og indsætte det i stedet. Dvs. at hvis #der er stor forskel i hvor meget det regner i de forskellige områder, vil fill_gaps() give en meget bedre imputation.
